...
- Step 5 (final document review) is mandatory and non-skippable — drafts that "looked fine while writing" commonly end up over budget, with broken markdown formatting, or with leftover placeholder text after the Step 4 revisions.
...
- Read any existing `cv/main_*.md` file as a structural reference
- Read any existing `cover_letters/cover_*.md` or `cover_letters/Cover_*.md` file as a template reference

### CV (`cv/main_<company>.md`)
- Always in **English**
- Follow the markdown structure and formatting conventions from `05-cv-templates.md`
- Tailor the profile statement and experience bullets to the specific role
- Reframe skills and achievements to match job requirements
- Stay within the ~2-page content budget from `05-cv-templates.md`

### Cover Letter (`cover_letters/cover_<company>_<role>.md`)
- **Match the language of the job posting** (Danish posting -> Danish cover letter, English posting -> English cover letter)
- Follow the markdown structure from `06-cover-letter-templates.md`
- Tailor the opening paragraph to the specific role and company
- Address to a named person if available in the posting, otherwise "Dear Hiring Manager" (or equivalent in posting language)
- Keep body text within the 250-300 word budget
...
<CV_DRAFT file="cv/main_<COMPANY>.md">
<INSERT_CV_DRAFT_HERE>
</CV_DRAFT>

<COVER_LETTER_DRAFT file="cover_letters/cover_<COMPANY>_<ROLE>.md">
...
```json
{
  "file": "cv/main_<COMPANY>.md" | "cover_letters/cover_<COMPANY>_<ROLE>.md",
...
## Step 5: DRAFTER - Final Document Review (MANDATORY)

**Never skip this step.** Drafts that looked fine while writing commonly end up over budget, with broken markdown formatting, or with leftover placeholder text after the Step 4 revisions. Re-read both files from disk and verify before presenting.

### 5a. Inspect formatting and length

**CV (`cv/main_<company>.md`):**
- [ ] Within the ~2-page content budget from `05-cv-templates.md` (section-by-section limits: profile 3-4 lines, 5 skills, 4-5 bullets for the most recent role, etc.)
- [ ] Markdown structure matches `05-cv-templates.md`: consistent heading levels, dates on italicized lines, bold-label bullets, no nested lists deeper than one level
- [ ] No broken lists, stray formatting characters, or placeholder tokens

**Cover letter (`cover_letters/cover_<company>_<role>.md`):**
- [ ] Body text within the 250-300 word budget
- [ ] Structure matches `06-cover-letter-templates.md`: name header, contact line, date, salutation, paragraphs, bullet list, closing, printed name
- [ ] No broken lists, stray formatting characters, or placeholder tokens

### 5b. Iterate until clean

If either document is over budget, cut content using **relevance-weighted cutting** (see `05-cv-templates.md` → "Relevance-weighted cutting"). Score each candidate line by (a) relevance to THIS posting's keywords and responsibilities, (b) uniqueness (is it duplicated elsewhere?), (c) narrative load (does the cover letter depend on it?). Cut the lowest-total-score line first, regardless of section. Do NOT mechanically apply a static section-based priority order — an older-role bullet that hits posting keywords is worth more than a recent-role bullet that does not.

For an overlong cover letter: first cut sentences that restate what a bullet already said; then a bullet that does not hit posting keywords; last resort, a bullet that does hit posting keywords.

Do not proceed to Step 6 until both documents pass inspection.
...
- `cv/main_<company>.md`
- `cover_letters/cover_<company>_<role>.md`
