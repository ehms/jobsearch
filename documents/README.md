...
```
documents/
├── cv/                          # Your CV files (PDF or Markdown)
...
│       ├── cover_letter.md      # The cover letter you submitted
│       ├── cv_draft.md          # The CV variant you submitted
...
**`cover_letter.md`** — The cover letter you actually submitted. Used to extract writing style patterns and structure for `06-cover-letter-templates.md`. (Legacy `.tex` files from past applications are also readable.)

**`cv_draft.md`** — The CV variant you submitted. Used to extract profile statement styles for `05-cv-templates.md`. (Legacy `.tex` files from past applications are also readable.)
...
| `.md` | Yes | Plain text |
| `.tex` | Yes | Legacy LaTeX source from past applications — still readable |
| `.txt` | Yes | Plain text |
